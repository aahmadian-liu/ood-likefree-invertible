...
class FASHION(object):
    ...
    def __init__(self, dataroot, train=True, transform=None):
        self.mnist = vdsets.FashionMNIST(dataroot, train=train, download=True, transform=transform)
...
class CIFAR100(object):
    ...
    def __init__(self, dataroot, train=True, transform=None):
        self.cifar10 = vdsets.CIFAR100(dataroot, train=train, download=True, transform=transform)
