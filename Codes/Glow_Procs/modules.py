...
class Split2d(nn.Module):
    ...
    def forward(self, input, logdet=0., reverse=False, temperature=None):
        if reverse:
            ...
            #*
            # extracting the 'standard normal noise' component, by normalizing the latent vriable sample given its mean and variance
            stcode= ToStandard(z2,mean,logs)

            return z1, logdet, stcode
...
#*
# see the 'Split2d' class
def ToStandard(z,mean,logs):
